  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      ...
      <header className="bg-gray-800 border-b border-gray-700 px-6 py-3 flex items-center justify-between">
        <span className="text-xl font-semibold tracking-tight">SQLOps Guardian</span>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 px-6 py-3 text-center text-sm text-gray-600">
